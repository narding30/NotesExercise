/*
  ...
  All rights reserved.
 */
package com.codev.recruitment.benhardrivera.data.repository
...
class ContactsRepository @Inject constructor(
     ...
     */
    suspend fun upsert(contact : Contacts) = contactsDao.upsert(contact)
     ...
     */
    suspend fun delete(contact: Contacts) = contactsDao.delete(contact)
}
